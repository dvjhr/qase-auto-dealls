...
test('MNT_MDK_001 - Find mentor by VALID nama mentor', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Cari berdasarkan nama,' }).fill('Mentor');
  await expect(
    page.locator(
      "//a[starts-with(@href, '/mentoring/')][contains(normalize-space(.), 'Mentor')]"
      ).first()).toContainText('Mentor', { ignoreCase: true });
});

test('MNT_MDK_002 - Find mentor by VALID pengalaman', async ({ page }) => {
...
test('MNT_MDK_003 - Find mentor by VALID nama perusahaan', async ({ page }) => {
...
test('MNT_MDK_004 - Find mentor by VALID topik keahlian', async ({ page }) => {
  let find_textbox = "//input[@id='searchMentor']";
  let keyword = 'Topic 1';
  await page.goto('https://job-portal-user-dev-skx7zw44dq-et.a.run.app/mentoring');
  await page.locator(
...
test('MNT_MDK_005 - Find mentor by VALID pendidikan', async ({ page }) => {
  let find_textbox = "//input[@id='searchMentor']";
  let keyword = "University of Indonesia";
  await page.goto('https://job-portal-user-dev-skx7zw44dq-et.a.run.app/mentoring');

  clickAndCheckTab(page, 'Akademik (S1 & S2)');
...
test('MNT_MDK_006 - Find mentor by INVALID keyword', async ({ page }) => {
  let find_textbox = "//input[@id='searchMentor']";
  let keyword = '123;>=-';
...
test('MNT_MDC_001 - Find mentor by VALID tab', async ({ page }) => {
  let find_textbox = "//input[@id='searchMentor']";
  await page.goto('https://job-portal-user-dev-skx7zw44dq-et.a.run.app/mentoring');
...
test('MNT_MDC_002 - Find mentor by VALID category in Karier tab', async ({ page }) => {
...
test('MNT_MDC_003 - Find mentor by VALID category in Akademik tab', async ({ page }) => {
  const expectedApiUrlPath = '/v2/mentoring/mentor/list';
...
test('MNT_MDC_005 - Sort mentor list', async ({ page }) => {
  await page.goto('https://job-portal-user-dev-skx7zw44dq-et.a.run.app/mentoring');
  const expectedApiUrlPath = '/v2/mentoring/mentor/list';
